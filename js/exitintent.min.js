...
// Custom code
$(document).ready(function(){if($.exitIntent){$.exitIntent("enable");var o=!1,s=12e4;function n(){setTimeout(function(){o=!0},s)}$("html").hasClass("test")&&(s=1e3),console.log(s),$(".exit_popup .close").click(function(){posY=$(window).scrollTop(),$(".exit_popup").modal("hide").hide().css("display","none"),$(".modal-bg").addClass("modal-open").css("display","none")}),n(),$(document).bind("exitintent",function(){o&&(o=!1,n(),posY=$(window).scrollTop(),$(".exit_popup").modal("show").show().popup("show").css("display","block"),$(".modal-bg").addClass("modal-open").css("display","block"))})}});
